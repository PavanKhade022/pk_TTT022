            ...
            public void run() {
                ...
                if(movePlayed) {
                    ...
                    if (board.playerWon && !board.draw) {
                        ...
                        board.setButtonDisabled(false);
                    }

                    else if (board.computerWon && !board.draw) {
                        board.text.setText("Computer Won!");
                        board.replay.setVisibility(View.VISIBLE);
                        board.setButtonDisabled(false);
                        board.player2points++;
                    }
                    else if (board.draw) {
